...
public class EGCLScript {
	...
	public String toAspectJOnline() {
		...
		for (Foreach f : foreaches)
			f.toAspectJOnline(aspectJrules);

		// Add the remaining rules
		for (Rule r : rules)
			r.toAspectJOnline(aspectJrules);

		return aspectJrules.toString();
	}

	public String toAspectJOffline() {
		AspectJScript aspectJrules = new AspectJScript();
		...
		// Add the remaining rules
		for (Rule r : rules)
			r.toAspectJOffline(aspectJrules);
