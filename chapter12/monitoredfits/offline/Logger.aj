	...
	before(): execution(* *.main(..)) {
		try {
			outputWriter = 
				...
				"/Users/gordon/Library/Containers/com.softwareambience.Unclutter/Data/Library/Application Support/Unclutter/FileStorage/Research/Writing Now/rv-book/final-code/project-sources/chapter12/log/log.txt"
			)));
		} catch (IOException e) {
				e.printStackTrace();
		}
