...
public class EGCLScript {
	...
	public HashSet<String> getExceptionNames() {
		HashSet<String> exception_names = new HashSet<>();

		for (Rule rule : getRules())
			if (rule.getThrowsException() != null)
				exception_names.add(rule.getThrowsException());

		for (Foreach f : getForeaches())
