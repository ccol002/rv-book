...
public class Main {
	...
	public static void main(String[] args) {
		String path = "/Users/chris/Drive Work/Repositories/rv-book-final/rv-book/final-code/project-sources/chapter08-parametrised-solutions/";
		...
		try {
			REScript script = new REScript(path + "script/properties.re");
