...
public class UserInfo {
	...
	private ArrayList<BankAccount> bankAccountsSnapshot;

	public void saveBankAccountsSnapshot() {
		// Clone the accounts individually
		bankAccountsSnapshot = new ArrayList<BankAccount>();

		for (BankAccount a : accounts)
			bankAccountsSnapshot.add((BankAccount) a.clone());
	}

	public void restoreBankAccountsSnapshot() {
		// Restore accounts
		accounts = bankAccountsSnapshot;

		// Reset snapshot
		bankAccountsSnapshot = null;
	}
